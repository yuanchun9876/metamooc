...
<div class="wrapper">
  ...
  <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i> 科目单元</a></li>
          <li class="active"><a href="#">科目单元查询</a></li>
        </ol>
      </section>
         ...
         <form name="infoForm" id="queryForm" method="post" >
        	...
        	<div class="box-body no-padding">
        		<table class="table table-striped">
        			...
        			<tr >
        			  <td >${i.count }</td>
        			  <td ><input type="checkbox" name="ids" value="1" value="${subj.subjId }"></td>
        				<td >${subj.subjTitle }</td>
        				<td >${subj.subjNum }</td>
        				<td >${subj.subjCode }</td>
        				<td >${subj.subjProgress }</td>
        				<td >${subj.subjInfo }</td>
						<td>
							<button type="button" class="btn btn-primary btn-sm" onclick="javascript:editpage('${subj.subjId }')">修改</button>
						</td>
        			</tr>
        			</c:forEach>
        		</table>
