...
<div class="wrapper">
  ...
  <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i> 教师</a></li>
          <li class="active"><a href="#">教师查询</a></li>
        </ol>
      </section>
         ...
         <form name="infoForm" id="queryForm" method="post" >
        	...
        	<div class="box-body no-padding">
        		<table class="table table-striped">
        			...
        			<c:forEach items="${list }" var="tch" varStatus="i">
        			<tr >
        			  <td >${i.count }</td>
        			  <td ><input type="checkbox" name="ids" value="1" value="${tch.tchId }"></td>
        				<td >${tch.tchName }</td>
        				<td >${tch.tchSex }</td>
        				<td ><fmt:formatDate value="${tch.tchRegTime }"  pattern="yyyy-MM-dd" />   </td>
        				<td >${tch.tchInfo }</td>
						<td>
							<button type="button" class="btn btn-primary btn-sm" onclick="javascript:editpage('${scth.tchId }')">修改</button>
						</td>
        			</tr>
        			</c:forEach>
        		</table>
