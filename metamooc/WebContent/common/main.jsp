			...
			<nav class="navbar navbar-static-top">
				...
				<div class="navbar-custom-menu">
					<ul class="nav navbar-nav">
						...
						<img src="<%=request.getContextPath()%>/static/dist/img/damo.jpg" class="user-image" alt="达摩老师"> <span class="hidden-xs">操作</span>
						</a>
							<ul class="dropdown-menu">
								<!-- User image -->
								<li class="user-header"><img src="<%=request.getContextPath()%>/static/dist/img/damo.jpg" class="img-circle" alt="张三丰老师">
									<p>
										达摩 <small>人生如戏，全靠演技</small>
									</p>
								</li>
								<!-- Menu Body -->
								<li class="user-body">
			...
			<section class="sidebar">
				...
				<div class="user-panel">
					<div class="pull-left image">
						<img src="<%=request.getContextPath()%>/static/dist/img/damo.jpg" class="img-circle" alt="User Image">
					</div>
